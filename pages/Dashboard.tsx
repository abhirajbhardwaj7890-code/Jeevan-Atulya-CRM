...
import { Member, Account, Interaction, Notification } from '../types';
...
export const Dashboard: React.FC<DashboardProps> = ({ members, accounts, interactions }) => {
  ...
  const branchPerformance = MOCK_BRANCHES.map(branch => {
